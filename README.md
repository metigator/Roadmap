...
```mermaid
timeline
    title  الهدف من الاسبوع الاول هو التعرف منصة الدوت نت واصداراتها المختلفة وكيفية تهيئة جهاز الكمبيوتر الخاص فيك للبدء في عمل تطبيقات دوت نت عليه والتعامل مع IDE's   
