...
```mermaid
timeline
    title الهدف من الاسبوع الاول هو التعرف منصة الدوت نت واصداراتها المختلفة وكيفية تهيئة جهاز الكمبيوتر الخاص فيك للبدء في عمل تطبيقات دوت نت عليه والتعامل مع بيئات التطوير وكيفية عمل البرنامج والتعامل مع السوليوشن والمشروع والتعامل مع عناصر التطبيق وعمل اول تطبيق والتعرف على مبادئ واساسيات المتغيرات والتعامل معها.
